...
<div class="header header-one">
    <a href=""  class="d-inline-flex d-sm-inline-flex align-items-center d-md-inline-flex d-lg-none align-items-center device-logo">
         <img src="{{asset('backend/assets')}}/img/logo.png" class="img-fluid logo2" alt="Logo">
    </a>
    <div class="main-logo d-inline float-start d-lg-flex align-items-center d-none d-sm-none d-md-none">
        <div class="logo-white">
            <a href="">
                <img src="{{asset('backend/assets')}}/img/logo.png" class="img-fluid logo-blue" alt="Logo">
            </a>
            <a href="">
                <img src="{{asset('backend/assets')}}/img/logo.png" class="img-fluid logo-small" alt="Logo">
            </a>
        </div>
    ...
    <div class="top-nav-search d-none">
        <form>
            ...
            <button class="btn" type="submit"><img src="{{asset('backend/assets')}}/img/icons/search.svg" alt="img"></button>
        </form>
    </div>
    <!-- /Search -->
        ...
        <li class="nav-item dropdown has-arrow flag-nav d-none">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{asset('backend/assets')}}/img/flags/us.png" alt="flag" ><span>English</span>
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{asset('backend/assets')}}/img/flags/fr.png" alt="flag" ><span>French</span>
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{asset('backend/assets')}}/img/flags/es.png" alt="flag" ><span>Spanish</span>
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{asset('backend/assets')}}/img/flags/de.png" alt="flag" ><span>German</span>
                </a>
            </div>
        </li>
        <!-- /Flag -->
                    ...
                    <ul class="notification-list">
                            ...
                            <a href="profile.html">
                                <div class="d-flex">
                                    <span class="avatar avatar-md active">
                                        <img class="avatar-img rounded-circle" alt="avatar-img" src="{{asset('backend/assets')}}/img/profiles/avatar-02.jpg">
                                    </span>
                        ...
                        <li class="notification-message">
                            <a href="profile.html">
                                <div class="d-flex">
                                    <span class="avatar avatar-md active">
                                        <img class="avatar-img rounded-circle" alt="avatar-img" src="{{asset('backend/assets')}}/img/profiles/avatar-10.jpg">
                                    </span>
                                    <div class="media-body"> 
                            ...
                            <a href="profile.html">
                                <div class="d-flex">
                                    <span class="avatar avatar-md">
                                        <img class="avatar-img rounded-circle" alt="avatar-img" src="{{asset('backend/assets')}}/img/profiles/avatar-13.jpg">
                                    </span>
                                    <div class="media-body">   
                        ...
                        <li class="notification-message">
                            <a href="profile.html">
                                <div class="d-flex">
                                    <span class="avatar avatar-md">
                                        <img class="avatar-img rounded-circle" alt="avatar-img" src="{{asset('backend/assets')}}/img/profiles/avatar-05.jpg">
                                    </span>
                                    <div class="media-body">  
